...
class CoapClientConnector(IRequestResponseClient):
    ...
    async def _handleGetRequest(self, resourcePath: str = None, enableCON: bool = False, uriAndResourcePath=None):
        try:
            msgType = NON
...
class HandleActuatorEvent():
    def __init__(self, listener: IDataMessageListener = None, resourcePath: str = None, requests=None):
        ...
        self.resourcePath = resourcePath if resourcePath is not None else self.get_default_resource_path()
        ...
        def get_default_resource_path(self):
            return None
